...
#________________________________________________________Ket_____________________________________________

#yg 1 2 3 4 bisa di ganti  tapi harus ada 4 untuk (`id`, `judul`, `deskripsi`, `url`, `kata_kunci`) yang __Ket__ sampai ini hapus