...
<body onmousemove="closesubnav(event);">
  ...
  <div id="masthead">
    ...
    <div id="pagecell1">
      ...
      <div id="pageName">
        <h2>Tools</h2>
        <img alt="small logo" src="https://image.flaticon.com/icons/svg/771/771605.svg" height="59" width="66"/>
      </div>
      <div id="pageNav">
        <center>	
      ...
      <div id="content">
       <a href="tools/coding.php" style="text-decoration:none">
        <div id="tools" class="feature">
          <img src="https://www.flaticon.com/premium-icon/icons/svg/1779/1779335.svg" alt="" width="280" height="200" />
          <h3>
            <span id="coding" class="style2">Coding</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Untuk kalian yang ingin mencoba hasil codng kalian, kalian dapat membuatnya secara langsung atau hanya preview hasil coding kalian saja.</strong>
            </span>
          </p>
          <p>&nbsp;</p>
      ...
      <br>
      <br>
      <a href="tools/converter.php" style="text-decoration:none">
        <div id="tools" class="feature">
          <img src="https://image.flaticon.com/icons/svg/1366/1366938.svg" alt="" width="280" height="200" />
          <h3>
            <span id="coding" class="style2">converter</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Untuk kalian yang ingin mencoba hasil codng kalian, kalian dapat membuatnya secara langsung atau hanya preview hasil coding kalian saja.</strong>
      ...
      <br>
      <br>
      <a href="tools/lainnya.php" style="text-decoration:none">
        <div id="tools" class="feature">
          <img src="source/gambar/tools_lainnya.png" alt="" width="280" height="200" />
          <h3>
            <span id="coding" class="style2">Lainnya</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Untuk kalian yang ingin mencoba hasil codng kalian, kalian dapat membuatnya secara langsung atau hanya preview hasil coding kalian saja.</strong>
