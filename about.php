...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>About Me </h2>
      <img title="NANI!!!!" style="cursor:wait" alt="small logo" onMouseOut="this.src='https://img.icons8.com/ios/2x/gender-neutral-user-filled.png';" onMouseOver="this.src='guguy.jpg';" src="https://img.icons8.com/ios/2x/gender-neutral-user-filled.png" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>	
    ...
    <div id="content">
      <h1  align="center" class="style1">About Me </h1>
      <br>
      <br>
      <div align="center" class="style3">
        <p>Hey guy's saya akan memperkenalkan diri saya karena ada yang kalian ingin tahu tentang saya. Nah, ok maka dari itu saya akan kasih tahu beberapa informasi tentang saya. Ok lanjut</p>
        <table width="770px" height="180" border="0">
          <tr>
            <td valign="middle" height="30px" width="10">1.</td>
            <td align="left" valign="middle" width="50">Q:</td>
            <td width="454" align="left" valign="middle">Kak nama kakak apaan? </td>
            <td align="left" valign="middle" width="50">A:</td>
            <td align="left" valign="middle" width="455">Tengku Revino B P </td>
          </tr>
          <tr>
            <td valign="middle" height="30px" width="10">2.</td>
            <td align="left" valign="middle" width="50">Q:</td>
            <td align="left" valign="middle">Tinggal dimana kak? </td>
            <td align="left" valign="middle" width="50">A:</td>
            <td title="klik me" align="left" valign="middle">Bumi, Indonesia, Jakarta Timur , Jatinegara </td>
          </tr>
          <tr>
            <td valign="middle" height="30px" width="10">3.</td>
            <td align="left" valign="middle">Q:</td>
            <td align="left" valign="middle"> Kak jenis kelaminnya apaan? </td>
            <td align="left" valign="middle" width="50">A:</td>
            <td align="left" valign="middle"> Laki-laki </td>
          </tr>
          <tr>
            <td valign="middle" height="30px">4.</td>
            <td align="left" valign="middle">Q:</td>
            <td align="left" valign="middle">Kak kok jawabnya singkat amat? </td>
            <td align="left" valign="middle">A:</td>
            <td align="left" valign="middle">Ya, karena privasi hahaha </td>
          </tr>
        </table>
        <p>ya, guy's jadi itu saja jadi cuma itu saja yang bisa saya kasih tahu kalau kelebihan ntar malah kagak privasi lagi wkwkwk </p>
        <p class="style3">&nbsp;</p>
      </div>
    </div>
