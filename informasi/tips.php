...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>Tips</h2>
      <img alt="small logo" src="https://image.flaticon.com/icons/png/128/77/77487.png" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>
    ...
    <div id="content">
      <a href="tips/shortcut.php" style="text-decoration:none">
        <div id="dreamweaver" class="feature">
          <tr>
            <img src="https://img.icons8.com/ios/2x/shortcut-filled.png" alt="" width="280" height="200" />
            <h3>
              <span id="shortcut" class="style2">Shortcut</span>      
            </h3>
            <p><strong>Dengan hadirnya fitur-fitur baru, maka ada banyak hal berbeda yang ditawarkan oleh perusahaan / pengembang software, salah satunya adalah shortcut. Tujuan shortcut adalah untuk mempermudah juga mempercepat proses pengerjaan oleh sang pengguna software tersebut. </strong></p>
