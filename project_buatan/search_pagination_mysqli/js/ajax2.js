...
// Function ini untuk mengirim data kata_kunci dan pagination dengan AJAX
function searchWithPagination(page_number, search){
	...
	$.ajax({
		url: 'search2.php', // File tujuan
		type: 'POST', // Tentukan type nya POST atau GET
		data: {kata_kunci: $("#kata_kunci").val(), page: page_number, search: search}, // Set data yang akan dikirim
		dataType: "json",
