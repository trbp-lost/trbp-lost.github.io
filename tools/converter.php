...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>Converter</h2>
      <img alt="small logo" src="https://image.flaticon.com/icons/svg/1366/1366938.svg" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>
    ...
    <div id="content">
      <a href="converter/text_to_link.php" style="text-decoration:none; color:black;">
        <div id="isi" class="feature">
          <img src="https://image.flaticon.com/icons/png/512/699/699903.png" alt="" width="280" height="200" />
          <h3>
            <span id="dreamweaver" class="style2">Text to Link</span>
          </h3>
          <p>
            <span class="style5">
              <strong> Tools pada kali ini dapat membuat dari text menjadi link sehingga jika di klik dapat langsung menuju website / situs yang akan kalian buat.
              </strong>
            </span>
          </p>
          <p>&nbsp;</p>
      ...
      <br>
      <br>
      <a href="converter/youtube_downloader.php" style="text-decoration:none; color:black;">
        <div id="isi" class="feature">
          <img src="https://image.flaticon.com/icons/svg/33/33265.svg" alt="" width="280" height="200" />
          <h3>
            <span id="dreamweaver" class="style2">Youtube Downloader</span>
          </h3>
          <p>
            <span class="style5">
              <strong> Dapat mendownload video atau lagu dari youtube.</strong>
            </span>
          </p>
          <p>&nbsp;</p>
          <p>
