...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>Lainnya</h2>
      <img alt="small logo" src="../source/gambar/tools_lainnya.png" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>
    ...
    <div id="content">
      <div id="isi" class="feature">
        <a href="lainnya/unshort_link.php" style="text-decoration:none; color: black;">
          <img src="../source/gambar/unshort_link.png" alt="" width="280" height="200" />
          <h3>
            <span id="isi-content" class="style2">Unshort link</span>
          </h3>
          <p>
            <span class="style5">
              <strong> Tools kali ini adalah untuk memperpanjang link yang telah di singkat dan melihat url asli juga tampilan websitenya, sehingga kalian dapat terhindar dari phising / malacius attack.</strong>
            </span>
          </p>
          <p>&nbsp;</p>
          <p>
      ...
      <br>
      <div id="isi" class="feature">
        <a href="lainnya/url_to_text.php" style="text-decoration:none; color: black;">
          <img src="../source/gambar/url_to_txt.png" alt="" width="280" height="200" />
          <h3>
            <span id="isi-content" class="style2">Url to Text</span>
          </h3>
          <p>
            <span class="style5">
              <strong> Tools ini adalah dapat menangkap atau mengambil isi pada website dengan cara memasukan url / website dan bagian awal untuk bagian awal yang diambil juga bagian akhir yang dtutup. </strong>
            </span>
          </p>
          <p>&nbsp;</p>
          <p>
      ...
      <br>
      <div id="isi" class="feature">
        <a href="lainnya/enkripsi_encoder.php" style="text-decoration:none; color: black;">
          <img src="https://image.flaticon.com/icons/svg/1410/1410167.svg" alt="" width="280" height="200" />
          <h3>
            <span id="isi-content" class="style2">Enkripsi Encoder</span>
          </h3>
          <p>
            <span class="style5">
              <strong> Tools ini adalah untuk mengubah dan mengaman kata/huruf/nama/dan lain - lain menjadi kode enkripsi, seperti: md5, base64 dan lain - lain. </strong>
            </span>
          </p>
          <p>&nbsp;</p>
          <p>
