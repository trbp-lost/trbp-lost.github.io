...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>Download</h2>
      <img alt="small logo" src="https://image.flaticon.com/icons/png/128/608/608258.png" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>
    ...
    <div id="content">
      <a href="download/game.php" style="text-decoration:none">
        <div id="isi" class="feature">
          ...
          <h3>
            <span id="kepala" class="style2">Game</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Terkadang hidup ini melelahkan dan menjenuh , saatnya kita menghilangkan lelah dan jenuh dengan bermain game.</strong>
            </span>
          </p>
          <p>
      ...
      <a href="download/software.php" style="text-decoration:none">
        <div id="isi" class="feature">
          ...
          <h3>
            <span id="software" class="style2">Software</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Terkadang kita bekerja tidak mungkin menggunakan bantuan aplikasi , karena aplikasi dibuat untuk memudahkan membuat sesuatu.</strong>
            </span>
          </p>
          <p>
            <strong>Download disini . . .! </strong>
      ...
      <a href="download/lagu/lagu.php" style="text-decoration:none">
        <div id="isi" class="feature">
          ...
          <h3>
            <span id="lagu" class="style2">Lagu</span>
          </h3>
          <p>
            <span class="style5">
              <strong>Sesuatu yang dapat menggambbarkan emosi dan kenagan , yah salah satunya adalah lagu yang terkadang membuat kita merasa nyaman dan tenang. </strong>
            </span>
          </p>
          <p>
            <strong>Download disini . . .! </strong>
      ...
      <a href="download/gambar.php" style="text-decoration:none">
        <div id="coreldraw_x7" class="feature">
          <img src="https://image.flaticon.com/icons/svg/23/23765.svg" alt="" width="280" height="200" />
          <h3>
            <span id="gambar" class="style2">Gambar</span>
          </h3>
          <p>
            <strong>Ingin cari gambar , gif dan lain lain yang bagus disini aja dijamin sesuai dan bagus pastinya dan memiliki macam gambar / lainnya.</strong>
          </p>
          <p>
            <strong>Download disini . . .! </strong>
          </p>
