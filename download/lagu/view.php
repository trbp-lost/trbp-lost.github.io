	...
	if(strlen($kata_kunci)<3){
		...
		if($num == 0){
			...
			while($row = $results->fetch_assoc()){
				...
				<table width="100%" border="0" style="text-decoration: none; color: black;">
					<tr>
						...
						<td width="80%">
							<h1 align="left"><?php echo $row['judul']; ?></h1>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<a href="<?php echo $row['url']; ?>">
							<button title="<?php echo $row['judul']; ?> Download"style="width: 100px; height: 30px; align-items: center;">Download</button>
						</a>
					</tr>
					<?php
			$no++;
