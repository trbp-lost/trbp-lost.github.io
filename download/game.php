...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="pageName">
      <h2>Game</h2>
      <img alt="small logo" src="https://image.flaticon.com/icons/png/512/1797/1797949.png" height="59" width="66"/>
    </div>
    <div id="pageNav">
      <center>
    ...
    <div id="content">
      <a href="game/battlefield2.php" style="text-decoration:none;">
        <div id="isi" class="feature">
          <img src="https://media.moddb.com/images/downloads/1/177/176940/9744eeb94e922c40456238074206bd46.png" alt="" width="280" height="200" />
          <h3>
           <span id="isi" class="style2">Battlefield 2 </span>
         </h3>
         <p>
          <strong>Yo kali ini saya ingin memperkenalkan game ini kepada kalian. Game ini sangat cocok kepada kalian yang mempunyai spesifikasi komputer / laptop yang potato<br>
          </strong>
        </p>
        <p>&nbsp;</p>
        <p>
    ...
    <br>
    <br>
    <a href="game/gta_indonesia.php" style="text-decoration:none">
      <div id="isi" class="feature">
        <img src="http://www.pcgamestar.net/wp-content/uploads/2016/09/GTA_Extreme_Indonesia.jpg" alt="" width="280" height="200" />
        <h3>
          <span id="isi" class="style2">GTA Indonesia</span>
        </h3>
        <p>
          <span class="style5">
            <strong>Apakah kalian masih ingat game greget satu ini kalian ingat berarti kalian masa kecilnya cukup bahagia karena kalian bertemu Si UCOK wkwkwk. </strong>
          </span>
        </p>
        <p>&nbsp;</p>
        <p>
