...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/das.css">
...
<body onmousemove="closesubnav(event);">
  ...
  <div id="pagecell1">
    ...
    <div id="breadCrumb"> 
      <a href="rules.php"> Contact	 Me </a> /   
    </div>
    <div id="pageName">
      <h2>Contact Me </h2>
      <img src="https://image.flaticon.com/icons/png/128/88/88460.png" height="52" width="66"/>
    </div>
    <div id="pageNav">
      <center>	
    ...
    <div id="content">
      <h1  align="center" class="style1">Contact Me </h1>
      <br>
      <br>
      <div align="center" class="style3">
        <p>Hey guy's saya akan memberikan kontak saya telepon / whats'up, facebook dan email saya . Ok silakan yang save nomor saya atau  mengirim pesan untuk masalah link kalian bisa komentar disitu kalau bisa di kasih solusi ya guy's. Ok mari kita mulai</p>
        <div>
          <div id="info-teja" title="Gmail">
            <span class="Tejatouch">
              <img src="https://image.flaticon.com/icons/png/128/732/732026.png" width="50" height="50" />
            </span>
            <div class="Tejainbox">
              <div class="Tejainbox2 teja15">
               <h2>Vinotengku@gmail.com</h2>
             </div>
           </div>
         </div>
       </div>
       ...
       <br>
       <div>
        <div id="info-teja" title="telepon/WA">
          <span class="Tejatouch">
            <img src="https://image.flaticon.com/icons/svg/1051/1051323.svg" width="50" height="50" />
          </span>
          <div class="Tejainbox">
            <div class="Tejainbox2 teja15">
             <h2>087765759265</h2>
     ...
     <br>
     <div>
      <div id="info-teja" title="Facebook">
        <span class="Tejatouch">
          <img src="https://image.flaticon.com/icons/png/128/69/69407.png" width="50" height="50" />
        </span>
        <div class="Tejainbox">
          <div class="Tejainbox2 teja15">
           <h2>tengku revino</h2>
